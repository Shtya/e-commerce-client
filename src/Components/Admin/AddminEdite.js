...
// import H_EditeProduct from "../../hook/H_Product/H_EditeProduct";
...
//     handleColors ,show, setShow ,color , setColor , handleEdite
//   ] = H_EditeProduct(id);
...
//           {
//             ImgPreview
//               ? ImgPreview.map((e,index)=> <img onClick={_=>handleRemove(e)} src={e} key={index} />)
//               : null
//           }
...
//           <input value={Price} onChange={e=> setPrice(e.target.value)} type="text"  className="input-form d-block mt-3 px-3"  placeholder="السعر قبل الخصم"/>
...
//           <button className="btn-save d-inline mt-2 " onClick={handleEdite}>حفظ التعديلات</button>
//         </Col>
//       </Row>
//       <ToastContainer />
//     </div>
