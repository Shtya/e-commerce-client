...
const Footer = () => {
    return (
        <div className="footer-background footer  pt-2 " style={{ maxHeight: "50px" }}>
            <Container className="">
                <Row className="d-flex justify-content-between align-items-center footer">
                    <Col sm="6" className="d-flex align-items-center footer1 ">
                    ...
                    <Col
                        sm="6"
                        className="d-flex justify-content-end align-items-center footer2 ">
